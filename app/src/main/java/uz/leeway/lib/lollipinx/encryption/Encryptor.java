package uz.leeway.lib.lollipinx.encryption;

import android.text.TextUtils;

import uz.leeway.lib.lollipinx.enums.Algorithm;

import java.security.MessageDigest;
import java.util.Locale;

/**
 * Used by {@link uz.leeway.lib.lollipinx.managers.AppLockImpl} to get the SHA1
...
public class Encryptor {
     ...
     * Select {@link Algorithm#SHA256} in {@link uz.leeway.lib.lollipinx.managers.AppLockImpl#setPasscode(String)}
