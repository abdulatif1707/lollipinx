...
import uz.leeway.lib.lollipinx.encryption.Encryptor;
import uz.leeway.lib.lollipinx.enums.Algorithm;
import uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface;
...
public class AppLockImpl<T extends AppLockActivity> extends AppLock implements LifeCycleInterface {
    ...
    /**
     * The activity class that extends {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     */
