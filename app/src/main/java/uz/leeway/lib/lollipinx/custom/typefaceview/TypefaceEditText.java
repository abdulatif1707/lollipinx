package uz.leeway.lib.lollipinx.custom.typefaceview;
...
import uz.leeway.lib.lollipinx.custom.typefaceview.interfaces.EditTextOnKeyImeInterface;

/**
 * Created by stoyand & oliviergoutay on 4/7/14.
 */
public class TypefaceEditText extends androidx.appcompat.widget.AppCompatEditText {
    /**
    ...
    private void setCustomTypeface(Context context, AttributeSet attrs) {
        ...
        @SuppressLint("CustomViewStyleable") TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.TypefaceView);
        int fontInt = styledAttrs.getInt(R.styleable.TypefaceView_tv_typeface, DEFAULT_TYPEFACE);
        styledAttrs.recycle();
