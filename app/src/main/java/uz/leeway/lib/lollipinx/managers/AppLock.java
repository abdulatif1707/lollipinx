...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     ...
     * take into account for the {@link uz.leeway.lib.lollipinx.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link uz.leeway.lib.lollipinx.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot(int appLockType);

    /**
     * Set the forgot option used by {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link uz.leeway.lib.lollipinx.managers.AppLock} by setting
     * {@link uz.leeway.lib.lollipinx.managers.AppLockImpl} as the
     * {@link uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link uz.leeway.lib.lollipinx.managers.AppLock} by removing any
     * {@link uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link uz.leeway.lib.lollipinx.managers.AppLock} by removing any
     * {@link uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface#onActivityPaused(android.app.Activity)}
     * and {@link uz.leeway.lib.lollipinx.interfaces.LifeCycleInterface#onActivityResumed(android.app.Activity)}
     */
     ...
     * {@link uz.leeway.lib.lollipinx.encryption.Encryptor} class.
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link uz.leeway.lib.lollipinx.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link uz.leeway.lib.lollipinx.managers.AppLockActivity} (it returns false)
